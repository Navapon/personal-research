...
@section('meta_tag')
    ...
    <meta name="description" content="{{ $journal->journal->rj_meta_tag }}">
...
@section('page-header')
    ...
    @include('components.page-header',[
        'header' => 'รายละเอียดวารสารวิชาการ'
    ])
                        ...
                        <div class="bs-callout bs-callout-danger">
                            ...
                            <ul class="list-group">
                                ...
                                <a class="list-group-item inactive-link" href="#">
                                    ...
                                    <p class="list-group-item-text">
                                        {{ $journal->journal->rj_evaluate_article or ' - ' }}
                                    </p>
                                </a>
                                ...
                                <a class="list-group-item inactive-link" href="#">
                                    ...
                                    <p class="list-group-item-text">
                                        {{ $journal->journal->publishlevel->rl_name or ' - ' }}
                                    </p>
                                </a>
                                ...
                                <a class="list-group-item inactive-link" href="#">
                                    ...
                                    <p class="list-group-item-text">
                                        ปี {{ $journal->journal->rj_volume or ' - ' }}
                                        ฉบับที่ {{ $journal->journal->rj_no or ' - ' }}
                                        หน้าที่ {{ $journal->journal->rj_page or ' - ' }}
                                    </p>
                                </a>
                                ...
                                <a class="list-group-item inactive-link" href="#">
                                    ...
                                    <p class="list-group-item-text">
                                        {{ $journal->journal->fund->fund_name or ' - '}}
                                    </p>
                                </a>
